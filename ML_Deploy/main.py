...
def predict():
    ...
    model_dict = {'CNN_js' :   ['static/MLModule/CNN.json','static/MLModule/CNN.h5'],
                  'model_js'    :   ['static/MLModule/model.json','static/MLModule/model.h5'],
                  'VGG16'       :   'static/MLModule/VGG16.h5',
                  'InceptionV3' :   'static/MLModule/InceptionV3.h5'}
...
def predict_result(model, run_time, probs, img):
    class_list = {'Daisy': 0, 'Dandelion': 1, 'Rose': 2, 'Sunflower': 3, 'Tulip': 4}
